...
namespace CPP.Framework.Services
{
    ...
    /// when an instance of the service is being initialized. Please note that the usage of this
    ...
    /// <see cref="CodeServiceSingleton.StartupInstance"/> method for this purpose.
    /// </summary>
    /// <example>
    ///     <para>
    ...
    public sealed class SingletonInstanceStartupMethodAttribute : Attribute { }
}
