...
namespace CPP.Framework.Diagnostics.Testing
{
    ...
    public class ExpectedArgumentNullExceptionAttribute : ExpectedArgumentExceptionAttribute
    {
        ...
        public ExpectedArgumentNullExceptionAttribute(string paramName) : base(paramName) { }
        ...
        public ExpectedArgumentNullExceptionAttribute(string paramName, string noExceptionMessage) : base(paramName, noExceptionMessage) { }

        /// <summary>
        /// Gets the expected type of the exception.
        /// </summary>
        public override Type ExceptionType { get { return typeof(ArgumentNullException); } }
    }
}
