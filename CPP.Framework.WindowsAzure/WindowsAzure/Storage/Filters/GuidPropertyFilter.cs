...
namespace CPP.Framework.WindowsAzure.Storage.Filters
{
    ...
    /// </summary>
    public class GuidPropertyFilter : TablePropertyFilter<Guid>
    {
        /// <summary>
        ...
        public GuidPropertyFilter(Expression expression, ComparisonOperator @operator, Guid filterValue)
        ...
        public override string GenerateFilterString()
        {
            ...
            return TableQuery.GenerateFilterConditionForGuid(this.Property.Name, queryOperator, this.FilterValue);
        }
    }
}
