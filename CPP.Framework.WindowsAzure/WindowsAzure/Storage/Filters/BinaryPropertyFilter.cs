...
namespace CPP.Framework.WindowsAzure.Storage.Filters
{
    ...
    /// </summary>
    public class BinaryPropertyFilter : TablePropertyFilter<Byte[]>
    {
        /// <summary>
        ...
        public BinaryPropertyFilter(Expression expression, ComparisonOperator @operator, Byte[] filterValue)
        ...
        public override string GenerateFilterString()
        {
            ...
            return TableQuery.GenerateFilterConditionForBinary(this.Property.Name, queryOperator, this.FilterValue);
        }
    }
}
