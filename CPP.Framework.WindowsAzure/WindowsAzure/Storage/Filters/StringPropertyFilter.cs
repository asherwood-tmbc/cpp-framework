...
namespace CPP.Framework.WindowsAzure.Storage.Filters
{
    ...
    /// </summary>
    public class StringPropertyFilter : TablePropertyFilter<String>
    {
        /// <summary>
        ...
        public StringPropertyFilter(Expression expression, ComparisonOperator @operator, String filterValue)
        ...
        public override string GenerateFilterString()
        {
            ...
            return TableQuery.GenerateFilterCondition(this.Property.Name, queryOperator, this.FilterValue);
        }
    }
}
