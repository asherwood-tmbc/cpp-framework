...
namespace CPP.Framework.WindowsAzure.Storage.Filters
{
    ...
    /// </summary>
    public class DoublePropertyFilter : TablePropertyFilter<Double>
    {
        /// <summary>
        ...
        public DoublePropertyFilter(Expression expression, ComparisonOperator @operator, Double filterValue)
        ...
        public override string GenerateFilterString()
        {
            ...
            return TableQuery.GenerateFilterConditionForDouble(this.Property.Name, queryOperator, this.FilterValue);
        }
    }
}
