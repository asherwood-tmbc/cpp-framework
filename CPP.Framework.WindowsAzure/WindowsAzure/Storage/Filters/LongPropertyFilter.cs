...
namespace CPP.Framework.WindowsAzure.Storage.Filters
{
    ...
    /// </summary>
    public class LongPropertyFilter : TablePropertyFilter<Int64>
    {
        /// <summary>
        ...
        public LongPropertyFilter(Expression expression, ComparisonOperator @operator, Int64 filterValue)
        ...
        public override string GenerateFilterString()
        {
            ...
            return TableQuery.GenerateFilterConditionForLong(this.Property.Name, queryOperator, this.FilterValue);
        }
    }
}
